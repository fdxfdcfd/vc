...
<div class="row">
    ...
    <div class="col-md-8 col-xs-12">
        <div class="white-box">
            ...
            echo form_open_multipart('admin/user/create', $formAttr, $hidden);
            ?>
            ...
            <div class="form-group">
                ...
                <div class="col-sm-12">
                    ...
                    <input onchange="readURL(this);" required type="file" name="user_img" id="user_img" accept="image/x-png,image/gif,image/jpeg" value="<?php echo base_url('public/images/users/').$user_img;?>" />
                </div>
            </div>
            <script>
