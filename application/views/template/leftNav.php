...
?>
<?php
$userData = $this->session->userdata('currentUser');
?>
                ...
                <div class="dropdown profile-element"> <span>
                    ...
                    <a data-toggle="dropdown" class="dropdown-toggle" href="#">
                            <span class="clear"> <span class="block m-t-xs"> <strong class="font-bold"><?php echo $userData['firstname']." ".$userData['lastname'] ?></strong>
                             </span> <span class="text-muted text-xs block"><?php echo $userData['position'];?> <b class="caret"></b></span> </span> </a>
...
<!--                        <li><a href="mailbox.html">Mailbox</a></li>-->
            ...
            <?php foreach ($leftNav as $menu):?>
                <li>
                    <a href="<?php echo base_url($menu->admin_menu_link);?>"><i class="fa <?=$menu->admin_menu_class?>"></i> <span class="nav-label"><?php echo $menu->admin_menu_name;?>
